...
//                mTextViewPremium.setTextColor(itemView.getContext().getResources().getColor(R.color.carbon_white));
                itemView.findViewById(R.id.layout).setBackgroundColor(Color.parseColor("#EDAC1A"));
                ...
                itemView.findViewById(R.id.layout).setBackgroundColor(Color.parseColor("#E06C42"));
