...
public class ActivityContents extends ActivityAppParent implements FragmentAbstract.InterfaceFragment, PermissionManager.InterfacePermission {
    private static final String TAG = ActivityContents.class.getSimpleName();
