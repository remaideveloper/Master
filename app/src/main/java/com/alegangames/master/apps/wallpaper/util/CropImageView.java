...
package com.alegangames.master.apps.wallpaper.util;
...
public class CropImageView extends FrameLayout{
    ...
    public Bitmap getCroppedImage() {
        ...
        if (mBitmap == null || mImageView == null) return null;
        final Rect displayedImageRect = ImageViewUtil.getBitmapRectCenterInside(mBitmap, this);
    ...
    private void init(Context context) {
        ...
        mImageView = (AvatarImageView) v.findViewById(R.id.ImageView_image);
        ...
        mImageView.setOnImageViewSizeChanged((v1, w, h) -> {


            mBitmap = resize(mBitmap, w, h);

            //mCropOverlayView.resetCropOverlayView();
            onSizeChanged(w,h, 1,1);
            setImageBitmap(mBitmap);
        });
        setImageResource(mImageResource);
        mCropOverlayView = v.findViewById(R.id.CropOverlayView);
        mCropOverlayView.setInitialAttributeValues(mGuidelines, mFixAspectRatio, mAspectRatioX, mAspectRatioY);
        mCropOverlayView.setLayoutParams(layoutParams);
    }
    ...
    public static Bitmap resize(Bitmap bit, int newWidth, int newHeight) {
        ...
        Bitmap resizedBitmap = Bitmap.createBitmap(bit, x, y,
