...
import com.remaistudio.master.util.FavoriteManager;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.share:
                ...
                return true;
            case R.id.edit:
                onAskPermissionSkin(this, EDIT_SKIN);
                return true;
            default:
...
//        int price = SkinUtil.getSkinPrice(category, number);
        ...
        saveButton.setColorNormal(ColorList.BLUE);
        saveButton.setColorPressed(ColorList.BLUE_LIGHT);
        saveButton.setColorRipple(ColorList.BLUE_DARK);
