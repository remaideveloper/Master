...
import com.remaistudio.master.activity.ActivityItem;
import com.remaistudio.master.apps.skins.ActivitySkinsCustom;
import com.remaistudio.master.apps.skins.ActivitySkinsStealer;
import com.remaistudio.master.apps.wallpaper.ActivityWallpaperPreview;
...
import static com.remaistudio.master.adapter.AdapterRecyclerView.CONTENT_MATCH_VIEW_TYPE;
import static com.remaistudio.master.adapter.AdapterRecyclerView.CONTENT_VIEW_TYPE;
import static com.remaistudio.master.adapter.AdapterRecyclerView.MENU_VIEW_TYPE;
import static com.remaistudio.master.adapter.AdapterRecyclerView.OFFER_VIEW_TYPE;
import static com.remaistudio.master.adapter.AdapterRecyclerView.PROMO_PAGER_VIEW_TYPE;
...
public class JsonItemFactory {
                ...
                if (!jsonArray.isNull(i)) {
                    ...
                    if (jsonObject != null) {
                        try {
                            ...
                            jsonObject.put("name", JsonHelper.checkLocaleJsonObject(jsonObject, "name"));

                            jsonObject.remove("description");
                            jsonObject.put("description", JsonHelper.checkLocaleJsonObject(jsonObject, "description"));
    ...
    public static Map<String, JsonItemFragment> getListJsonItemFragmentFromJsonArray(@Nullable JSONArray jsonArray){
        ...
        Map<String, JsonItemFragment> map = new ArrayMap<>();
